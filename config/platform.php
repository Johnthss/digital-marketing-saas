...
return [
    ...
    */
    ...
    'ai' => [
        ...
        'routing' => [
            'reasoning' => ['openai:gpt-4o', 'anthropic:claude-3-5-sonnet-20241022', 'google:gemini-1.5-pro'],
            'fast' => ['openai:gpt-4o-mini', 'anthropic:claude-3-haiku-20240307', 'google:gemini-1.5-flash'],
            'creative' => ['openai:gpt-4o', 'anthropic:claude-3-5-sonnet-20241022', 'google:gemini-1.5-pro'],
