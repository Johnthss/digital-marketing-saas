...
<div class="row"><div class="col-md-8"><div class="card"><div class="card-header"><h3 class="card-title">Edit Content Asset</h3></div>
    <form action="{{ route('content.update', $asset) }}" method="POST">@csrf @method('PUT')
        <div class="card-body">
            ...
            <div class="form-group"><div class="icheck-primary"><input type="checkbox" name="is_public" id="is_public" value="1" {{ $asset->is_public ? 'checked' : '' }}><label for="is_public">Public</label></div></div>
        </div>
